...
# DBTITLE 1,Schema Path Definitions
...
# DBTITLE 1,Create source dataframes
...
# DBTITLE 1,UDF Function to write table to the Unity Catalog
...
# DBTITLE 1,Enrich Function for customers table
...
# DBTITLE 1,transform orders table to change date format
...
# DBTITLE 1,enriched orders table
...
# DBTITLE 1,Create an aggregate table that shows profit
